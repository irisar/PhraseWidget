...
public class DataBaseHelper extends SQLiteOpenHelper{
	...
	public void createDataBase() {
		...
		Log.d("PhraseWidget", "¿DB EXISTS?: " + dbExist);
		if(dbExist){
			...
			try {
				...
				Log.d("PhraseWidget", "Error copiando base de datos: " + e.toString());
			}
		}
		Log.d("PhraseWidget", "Obtenida DB");
	}
	...
	private boolean checkDataBase(){
		...
		try{
			...
			Log.d("PhraseWidget", "DATABASE PATH: " + myPath);
